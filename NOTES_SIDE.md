Notes on Selenium IDE
=====================

These are some older notes on the Selenium IDE. This tactic could work but seems to be being overtaken by other approaches (see README.md).
